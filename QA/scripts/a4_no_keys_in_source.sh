#!/usr/bin/env bash
# A4 §14.7: no sk-/AIza/ghp_/xox- secret literals in A4 sources/tests.
set -uo pipefail
...
FILES=(
  ...
  "Tests/VaniScriptCoreTests/CloudModelCatalogTests.swift"
)
...
[[ "$rc" -eq 0 ]] || exit 1
echo "PASS: no hardcoded API keys/tokens in A4 sources or tests (§14.7)."
